...
const ResearchDownloadReportTable = ({ tableData }) => {
            ...
            {currentUserDevice === 'desktop' && (
              <thead>
                <tr>
                  ...
                  <th className='user-management-table-header'>Downloaded by</th>
                </tr>
              </thead>
            )}
                  ...
                  <tr key={index} className={`table-data-body-row`}>
                    <td className='table-data-item'>
                      <div className='text-block'>
                        <p className='user-management-title'>{item.upload_file.name}</p>
                      </div>
                    </td>
...
export default ResearchDownloadReportTable;
