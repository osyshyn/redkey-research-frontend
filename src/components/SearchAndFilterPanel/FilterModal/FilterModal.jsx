...
//     {
//       icon: <CompanyFilterIcon className="filter-icons" />,
//       label: "Companies",
//       value: "companies",
//     },
//     {
//       icon: <StatusFilterIcon className="filter-icons" />,
//       label: "Status",
//       value: "status",
//     },
//     {
//       icon: <CalendarFilterIcon className="filter-icons" />,
...
//     {
//       icon: <RegisteredByIcon className="filter-icons" />,
//       label: "Registered by",
//       value: "registered_by",
//     },
//     {
...
const FilterModal = ({
  ...
  const dropdownFolderOptions = [
    {
      icon: "company-filter", // вместо <CompanyFilterIcon />
      label: "Companies",
      value: "companies",
    },
    {
      icon: "status-filter", // вместо <StatusFilterIcon />
      label: "Status",
      value: "status",
    },
    {
      icon: "calendar-filter", // вместо <CalendarFilterIcon />
      label: "Initiation date",
      value: "initiation_date",
    },
  ];
  ...
  const dropdownUserManagementOptions = [
    {
      icon: "registered-by", // вместо <RegisteredByIcon />
      label: "Registered by",
      value: "registered_by",
    },
    {
